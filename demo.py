...
math_agent = Agent(
    ...
    backstory="YOU ARE A MATH WHIZ. Your friends know you to think of everything in a mathematical way",
    verbose=True,
    tools=[calculate],
    llm=llm
)
...
writer = Agent(
    role="Writer",
    goal="Craft compelling explanations based from results of math equations. The explainations must detail every single steps of the reasonning",
...
task2 = Task(
    ...
    were formed in a structured Markdown document""",
